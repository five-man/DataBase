create database project3; #데이터베이스 생성

use project3; #데이터베이스 사용
...
ALTER TABLE `algorithm_tag` ADD CONSTRAINT `FK_algorithm_TO_algorithm_tag_1` FOREIGN KEY (
	`algo_no`
)
REFERENCES `algorithm` (
	`algo_no`
...
ALTER TABLE `algorithm_tag` ADD CONSTRAINT `FK_tag_TO_algorithm_tag_1` FOREIGN KEY (
	`tag_id`
)
REFERENCES `tag` (
	`tag_id`
